...
const Service = () => {
  return (
    <div className='w-full h-screen  bg-zinc-900 text-white'>
      <Navbar/>
      <h1 className='text-center text-5xl mt-14 font-semibold'>OUR SPECIAL CHEF's</h1>
      <p className=' text-center w-[30%] text-zinc-200 mt-4 p-2 leading-tight text-lg  mx-auto'>Featured Below are some of Our special chef's who work for prepare your meal</p>
