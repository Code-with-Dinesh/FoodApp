...
const Home = () => {
  ...
  return (
    <div>
      <Navbar />
      <div className="w-full h-[50vh] bg-[url(https://images.unsplash.com/photo-1689020353604-8041221e1273?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D)] object-cover flex items-center justify-center">
