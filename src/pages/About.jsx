  ...
  return (
    ...
    <div className='w-full  bg-zinc-900  flex flex-col items-center text-white '>
      <div className=' w-[100%] p-10 h-screen flex flex-wrap gap-x-7  items-center'>
        ...
        <p className='mt-2 p-2'>Go Food offers a delightful dining experience, combining fast service with fresh, high-quality ingredients. Whether you're craving a quick bite or a full meal, our diverse menu caters to all tastes, ensuring satisfaction with every visit."</p>
        </div>
      </div>
    </div>
    </>
