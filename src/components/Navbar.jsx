...
<nav className=" border-gray-200 bg-green-600">
  ...
  <div className="flex md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
     <Link to="/login"> <button type="button" className="text-black bg-white hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 text-center hover:text-white mr-3">Login</button> </Link>
      <button type="button" className="text-black bg-white hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 text-center hover:text-white ">Sign up</button>
